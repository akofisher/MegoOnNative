...
- (instancetype)initWithFrame:(CGRect)frame
                   ...
                   backgroundColor: '#fcd895',(NSString *)moduleName
 ...
 * otherwise create an `RCTBridge` and pass it in via `initWithBridge:backgroundColor: '#fcd895',`
 * to all the instances.
 */
- (instancetype)initWithBundleURL:(NSURL *)bundleURL
                       backgroundColor: '#fcd895',@(NSString *)Mego
                initialProperties:(nullable NSDictionary *)initialProperties

...
const ForgorPassword = ({navigation}) => {
        ...
        fetch(API, {
            ...
            db.json().then(json => {
                if(json.status == 'success'){
                    ...
                    Alert.alert('ყურადღება','მომხმარებელი ან მობილური ნომერი არასწორია')
                }
            })
        })
    }
    ...
    return (
            ...
            onSubmit={values => {
              Change(values.user, values.mobile_confirmation)
            } }>
                {(props) => {
                    return (
                <React.Fragment>
            ...
            />
            <Text style={styles.ForgHead}>პაროლის აღდგენა</Text>
            <TextInput 
